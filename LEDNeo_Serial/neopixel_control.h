...
class NeoPixelControl {
  private:
    ...
    unsigned long chargingWaitMs = 5;
  ...
  public:
    NeoPixelControl(byte NeoPixelPin, unsigned long NeoPixelNum)
    {
...
//      setColorAll(colorSend);
    ...
    void setFade(int color[3], unsigned long fadeTime)
    {
      clearAllState();
      fadeColor[0] = color[0];
      fadeColor[1] = color[1];
    ...
    void setFade2(int color1[3], int color2[3], unsigned long fadeTime)
    {
      clearAllState();
      fade2_Color1[0] = color1[0];
      fade2_Color1[1] = color1[1];
    ...
    void setFade3(int color1[3], int color2[3], int color3[3], unsigned long fadeTime)
    {
      clearAllState();
      fade3_Color1[0] = color1[0];
      fade3_Color1[1] = color1[1];
    ...
    void setBlink(int color1[3], unsigned long blinkTime)
    {
      clearAllState();
      blink1_Color[0] = color1[0];
      blink1_Color[1] = color1[1];
    ...
    void setBlink2(int color1[3], int color2[3], unsigned long blinkTime)
    {
      clearAllState();
      blink2_Color1[0] = color1[0];
      blink2_Color1[1] = color1[1];
    ...
    void setBlink3(int color1[3], int color2[3], int color3[3], unsigned long blinkTime)
    {
      clearAllState();
      blink3_Color1[0] = color1[0];
      blink3_Color1[1] = color1[1];
